...
public class PtrFrameLayout extends ViewGroup {
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!moveDown && pullHeaderCanNotScrollOver && mPtrIndicator.getCurrentPosY() == 0)
                    return true;
    ...
    /**
     * If at the top and not in mb_loading, reset
     */
    ...
    /**
     * mb_loading will last at least for so long
     *
     * @param time
     */
